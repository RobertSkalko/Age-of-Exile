...
public class NonWeaponSuffixes implements ISlashRegistryInit {
    ...
    public void registerAll() {
        ...
        ElementalAffixBuilder.start()
            ...
            .tier(1, x -> Arrays.asList(new StatModifier(30, 35, new ElementalResist(x), ModType.FLAT)))
            .tier(2, x -> Arrays.asList(new StatModifier(25, 30, new ElementalResist(x), ModType.FLAT)))
            .tier(3, x -> Arrays.asList(new StatModifier(15, 25, new ElementalResist(x), ModType.FLAT)))
