...
public class BeneficialEffects implements ISlashRegistryInit {
    ...
    public void registerAll() {
        ...
        ExileEffectBuilder.of(ELE_RESIST, "-Ele Res", EffectType.BENEFICIAL)
        ...
        ExileEffectBuilder.of(THORN_ARMOR, "Thorn Armor", EffectType.BENEFICIAL)
                ...
                .spell(Builder.forEffect()
                        .onTick(PartBuilder.justAction(SpellAction.EXILE_EFFECT.create(NegativeEffects.THORNS, ExilePotionAction.GiveOrTake.GIVE_STACKS, 80D)).setTarget(TargetSelector.AOE.create(2D, EntityFinder.SelectionType.RADIUS, EntityFinder.EntityPredicate.ENEMIES)).onTick(20D))
