...
public class UnlockSpellStatSerializer<T extends DatapackSpellStat> implements IStatSerializer<T> {
    Function<String, T> newintance;

    public UnlockSpellStatSerializer(Function<String, T> newintance) {
