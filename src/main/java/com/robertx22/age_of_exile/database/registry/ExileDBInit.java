...
public class ExileDBInit {
    ...
    public static void initRegistries() {
        ...
        Database.addRegistry(new ExileRegistryContainer<>(ExileRegistryTypes.INGREDIENT, null).setIsDatapack());
        ...
        Database.addRegistry(new ExileRegistryContainer<>(ExileRegistryTypes.TRANSC_AFFIXES, new TranscendentAffix()).setIsDatapack());
