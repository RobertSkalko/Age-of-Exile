...
public class ExileDBInit {
    ...
    public static void initRegistries() {
        ...
        Database.addRegistry(new SpellContainer(ExileRegistryTypes.SPELL, Spell.SERIALIZER).setIsDatapack());
        ...
        Database.addRegistry(new ExileRegistryContainer<>(ExileRegistryTypes.REFORGE, null).setIsDatapack());
