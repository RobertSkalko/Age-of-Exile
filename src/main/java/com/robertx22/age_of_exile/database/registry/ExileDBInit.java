...
public class ExileDBInit {
    ...
    public static void initRegistries() {
        ...
        Database.addRegistry(new ExileRegistryContainer<>(ExileRegistryTypes.GEAR_SLOT, new GearSlot("", 0)).setIsDatapack());
        ...
        Database.addRegistry(new ExileRegistryContainer<>(ExileRegistryTypes.TIER, new Tier(0)).setIsDatapack());
        ...
        Database.addRegistry(new ExileRegistryContainer<>(ExileRegistryTypes.RUNEWORD, null).setIsDatapack());
        ...
        Database.addRegistry(new ExileRegistryContainer<>(ExileRegistryTypes.RACES, new PlayerRace()).setIsDatapack());
