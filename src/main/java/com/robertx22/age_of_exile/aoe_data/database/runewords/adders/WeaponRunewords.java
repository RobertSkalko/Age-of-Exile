...
public class WeaponRunewords implements ExileRegistryInit {
    ...
    public void registerAll() {
        RuneWord.create(
                ...
                Arrays.asList(
                    new StatModifier(0.1F, 0.1F, new AttackDamage(Elements.Fire), ModType.FLAT),
                    new StatModifier(0.1F, 0.1F, new AttackDamage(Elements.Water), ModType.FLAT),
                    new StatModifier(0.1F, 0.1F, new AttackDamage(Elements.Nature), ModType.FLAT)
                ),
        ...
        RuneWord.create(
                ...
                BaseGearType.SlotFamily.Weapon,
                Arrays.asList(
                    new StatModifier(1, 2, new AttackDamage(Elements.Nature), ModType.FLAT),
        ...
        RuneWord.create(
                ...
                BaseGearType.SlotFamily.Weapon,
                Arrays.asList(
                    new StatModifier(1, 2, new AttackDamage(Elements.Water), ModType.FLAT),
        ...
        RuneWord.create(
                ...
                BaseGearType.SlotFamily.Weapon,
                Arrays.asList(
                    new StatModifier(1, 2, new AttackDamage(Elements.Light), ModType.FLAT)
                ),
        ...
        RuneWord.create(
                ...
                BaseGearType.SlotFamily.Weapon,
                Arrays.asList(
                    new StatModifier(1, 2, new AttackDamage(Elements.Fire), ModType.FLAT),
        ...
        RuneWord.create(
                ...
                BaseGearType.SlotFamily.Weapon,
                Arrays.asList(
                    new StatModifier(1, 1.5F, new AttackDamage(Elements.Physical), ModType.FLAT),
