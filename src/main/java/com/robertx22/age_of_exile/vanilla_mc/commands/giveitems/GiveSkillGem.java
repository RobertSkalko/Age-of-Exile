...
import com.robertx22.age_of_exile.vanilla_mc.commands.suggestions.SkillGemRaritySuggestions;
import com.robertx22.age_of_exile.vanilla_mc.commands.suggestions.SkillGemSuggestions;
                    ...
                    .then(literal("skill_gem")
                        ...
                        .then(argument("target", EntityArgumentType.player())
                            .then(argument("id", StringArgumentType.word())
                                .suggests(new SkillGemSuggestions())
                                .then(argument("level", IntegerArgumentType.integer())
                                    .then(argument("rarity", StringArgumentType.word())
                                        .suggests(new SkillGemRaritySuggestions())
