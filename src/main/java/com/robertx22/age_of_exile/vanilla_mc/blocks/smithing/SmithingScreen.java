...
public class SmithingScreen extends ModificationGui<SmithingContainer, SmithingTile> {
    ...
    public SmithingScreen(SmithingContainer cont, PlayerInventory invPlayer, MutableText comp) {
        super(texture, cont, invPlayer, new LiteralText(""), SmithingTile.class);
        backgroundWidth = 176;
