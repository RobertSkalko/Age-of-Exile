...
public class CookingContainer extends BaseTileContainer {

    IInventory tile;

    public CookingContainer(int num, PlayerInventory invPlayer, PacketBuffer packet) {
        this(num, invPlayer, new Inventory(CookingTile.totalSlots()), packet.readBlockPos());
    }

    public CookingContainer(int i, PlayerInventory invPlayer, IInventory inventory,
                            BlockPos pos) {
