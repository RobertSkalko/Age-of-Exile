...
public class RenderLayersRegister {
    public static void setup() {
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(ModRegistry.BLOCKS.SUMMON_PORTAL, RenderLayer.getTranslucent());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(ModRegistry.BLOCKS.TRAP, RenderLayer.getCutout());
