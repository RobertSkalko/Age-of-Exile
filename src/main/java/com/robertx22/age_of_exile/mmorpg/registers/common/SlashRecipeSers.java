...
public class SlashRecipeSers {
    ...
    public static RegObj<SpecialRecipeSerializer<ProfCraftingRecipe>> PROF_CRAFTING = Def.recipeSer("prof_crafting", () -> new SpecialRecipeSerializer<>(ProfCraftingRecipe::new));
