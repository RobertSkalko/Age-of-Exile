...
public class C2SPacketRegister {
    ...
    public static void register() {
        ...
        Packets.registerClientToServerPacket(MMORPG.NETWORK, new RequestSyncCapToClient(), i++);
        ...
        Packets.registerClientToServerPacket(MMORPG.NETWORK, new OpenGuiPacket(), i++);
