...
public class MobAffixes implements ISlashRegistryInit {
    ...
    public static MobAffix OF_RUIN = new MobAffix("of_ruin", "Of Ruin", Affix.Type.suffix).setMods(new StatModifier(1, 1, new WeaponDamage(Elements.Physical), ModType.FLAT));
